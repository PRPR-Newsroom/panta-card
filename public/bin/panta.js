...
PluginController.prototype.getPluginConfiguration = function() {
  var a = new PluginConfiguration("1.2.2_Module-P", "Das Panta Plan Modul", new PluginCardConfig("Plan", "./assets/ic_plan.png", {file:"./plan.html"}), [this._repository.get({id:3}), this._repository.get({id:2})]);
