...
"module.beteiligt.layout-regular.desc":"Das Kontakt-Formular hat folgende Felder, die individualisert werden k\u00f6nnen.<p><i>Hinweis: Die hier konfigurierten Felder gelten f\u00fcr alle Reiter, die dieses Layout verwenden. Eine Konfiguration pro Reiter ist nicht m\u00f6glich.</i></p>", "module.beteiligt.layout-ad.desc":"Das Inserat-Formular hat folgende Felder, die individualisert werden k\u00f6nnen.<p><i>Hinweis: Die hier konfigurierten Felder gelten f\u00fcr alle Reiter, die dieses Layout verwenden. Eine Konfiguration pro Reiter ist nicht m\u00f6glich.</i></p>", 
"module.beteiligt.layout-blog.desc":"Das Blog-Formular hat folgende Felder, die individualisert werden k\u00f6nnen.<p><i>Hinweis: Die hier konfigurierten Felder gelten f\u00fcr alle Reiter, die dieses Layout verwenden. Eine Konfiguration pro Reiter ist nicht m\u00f6glich.</i></p>", "module.beteiligt.field-name.desc":"Das Feld ist ein individuell konfigurierbares Feld. Geben Sie hier die Beschriftung und Platzhalter an.", "module.beteiligt.field-social.desc":"Das Feld ist ein individuell konfigurierbares Feld. Geben Sie hier die Beschriftung und Platzhalter an.", 
...
var PluginController = function(a, b) {
  ...
  this._trelloApi = a;
  this._upgrading = !1;
  this._upgrades = {1:this._upgrade_1, 2:this._upgrade_2, 3:this._upgrade_3_to_4, 4:this._upgrade_4_to_5, 5:this._upgrade_5_to_6};
...
PluginController.prototype._upgrade_5_to_6 = function() {
  var a = this;
  return this.findPluginModuleConfigByModuleId(ModuleController.ID).then(function(b) {
    return b.config.layouts.hasOwnProperty("blog") ? (console.debug("Upgrading layout \u00abblog\u00bb by removing fields \u00abfield.follower\u00bb and \u00abfield.date\u00bb"), b.config.layouts.blog.fields = b.config.layouts.blog.fields.filter(function(a) {
      return "field.follower" !== a.id && "field.date" !== a.id;
    }), a.setPluginModuleConfig(b).then(function(b) {
      return a.getPluginConfiguration();
    })) : a.getPluginConfiguration();
  });
};
...
var BlogBeteiligt = function(a, b, c) {
  CommonBeteiligt.call(this, a, "", null, b, c);
  this.type = "blog";
};
...
BlogBeteiligt._create = function(a) {
  return a ? new BlogBeteiligt(JsonSerialization.getProperty(a, "id"), JsonSerialization.getProperty(a, "address"), JsonSerialization.getProperty(a, "notes")) : new BlogBeteiligt;
};
