...
$jscomp.global.Object.defineProperties(PluginRepository, {INSTANCE:{configurable:!0, enumerable:!0, get:function() {
  ...
  editables:[{id:"visual", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", type:"select", label:"Visual", color:"blue", show_on_front:!1, values:["Bild", "Icon", "Grafik", "Video", "Illu"]}, {id:"form", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", type:"select", label:"Form", color:"green", show_on_front:!1, values:["News", "Artikel", "Report"]}, {id:"online", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", 
  type:"select", label:"Online", color:"yellow", show_on_front:!1, values:"... Mo Di Mi Do Fr Sa So".split(" ")}, {id:"season", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", type:"select", label:"Saison", color:"sky", show_on_front:!1, values:["Sommer", "Herbst"]}, {id:"region", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", type:"select", label:"Region", color:"lime", show_on_front:!1, values:["Nord", "S\u00fcd"]}, {id:"place", desc:"Definieren Sie die Auswahlliste, die f\u00fcr das ganze Board gelten.", 
